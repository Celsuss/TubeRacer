...
//	...and its gravity.
	...
	//	Gravity toward the "planet".
		Vector3 gravForce = -Vector3.up * gravity;
	...
	//	Vehicle's relative "up" direction.
        ...
        UnityEngine.Physics.Raycast(frontLeft, -relUp, out frontLeftHit);
        UnityEngine.Physics.Raycast(frontRight, -relUp, out frontRightHit);
        UnityEngine.Physics.Raycast(backLeft, -relUp, out backLeftHit);
        UnityEngine.Physics.Raycast(backRight, -relUp, out backRightHit);
